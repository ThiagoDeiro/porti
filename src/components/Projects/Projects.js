    ...
    this.state = {
      projects: [
        ...
        },
        {
          ...
          tech:
            "React aplication with Rails Backend,CSS,Bootstrap and Zumato API"
        },
        {
          id: "p3",
          title: "Todos",
        ...
        },
        {
          ...
          tech:
            "JavaScript/React for front-end, Node/Express.js for back-end,MongoDB/Mongoose for database,S3/AWS for photos upload,Heroku for deployment,GitHub for version control."
        }
      ]
    };
  }
